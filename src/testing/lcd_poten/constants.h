...
#define CONFIG_REG_MUX_CHAN_0 		(0x4000) // Pinagem potenciometro 2 A0
#define CONFIG_REG_MUX_CHAN_1 		(0x7000) // Pinagem do potenciometro 1 A3
#define CONFIG_REG_MUX_CHAN_2 		(0x6000)
#define CONFIG_REG_MUX_CHAN_3 		(0x5000)
